...
const correctName = function (str) {
  const newStr = str.toLowerCase();
  const strCorrect = newStr[0].toUpperCase() + newStr.slice(1);
...
console.log(maskCreditCard(433356372727272777));
console.log(maskCreditCard('34567891234566789'));
